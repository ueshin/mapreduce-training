...
public class WordCount1ReducerTest {
    ...
    public void setUp() throws Exception {
        driver = new ReduceDriver<Text, LongWritable, Text, LongWritable>(new WordCount1Reducer());
    }

    /**
     * Test method for
     * {@link st.happy_camper.hadoop.mapreduce.training.wordcount1.mapreduce.WordCount1Reducer#reduce(org.apache.hadoop.io.Text, java.lang.Iterable, org.apache.hadoop.mapreduce.Reducer.Context)}
     * .
     */
    @Test
