...
public class WordCount1MapperTest {
    ...
    public void setUp() throws Exception {
        driver = new MapDriver<LongWritable, Text, Text, LongWritable>(new WordCount1Mapper());
    }

    /**
     * Test method for
     * {@link st.happy_camper.hadoop.mapreduce.training.wordcount1.mapreduce.WordCount1Mapper#map(org.apache.hadoop.io.LongWritable, org.apache.hadoop.io.Text, org.apache.hadoop.mapreduce.Mapper.Context)}
     * .
     */
    @Test
