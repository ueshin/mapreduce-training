 ...
 * @author ueshin
 */
public class MapSideJoinTest extends ClusterMapReduceTestCase {
     ...
     */
    @Test
    public void testMapSideJoin() throws Exception {
        FileSystem fs = getFileSystem();
        URI joinFileUri = new URI("links.txt#link");
        ...
        Job job = new MapSideJoin(createJobConf()).createJob(joinFileUri, new Path[] { getInputDir() }, getOutputDir());
